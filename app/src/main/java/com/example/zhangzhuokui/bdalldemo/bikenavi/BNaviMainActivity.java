package com.example.zhangzhuokui.bdalldemo.bikenavi;
...
public class BNaviMainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startPt = new LatLng(MapNormalUtil.LOCATION_LAT_CHUANGWEI,MapNormalUtil.LOCATION_LOG_CHUANGWEI);
        endPt = new LatLng(MapNormalUtil.LOCATION_LAT_HUAQIANGBEI, MapNormalUtil.LOCATION_LOG_HUAQIANGBEI);
    ...
    private void initMapStatus(){
        ...
        builder.target(new LatLng(MapNormalUtil.LOCATION_LAT_HUAQIANGBEI, MapNormalUtil.LOCATION_LOG_HUAQIANGBEI)).zoom(19);
    ...
    public void initOverlay() {
        ...
        MarkerOptions ooA = new MarkerOptions().position(startPt).icon(bdA)
                .zIndex(9).draggable(true);

        mMarkerA = (Marker) (mBaiduMap.addOverlay(ooA));
        mMarkerA.setDraggable(true);
        MarkerOptions ooB = new MarkerOptions().position(endPt).icon(bdB)
                .zIndex(5);
