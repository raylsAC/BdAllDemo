package com.example.zhangzhuokui.bdalldemo.navi;
...
//                eNode = new BNRoutePlanNode(116.39750, 39.90882, "北京天安门", null, coType／);
            ...
            case BD09LL: {
                sNode = new BNRoutePlanNode(MapNormalUtil.LOCATION_LOG_CHUANGWEI, MapNormalUtil.LOCATION_LAT_CHUANGWEI, "创维设计大厦", null, coType);
                eNode = new BNRoutePlanNode(MapNormalUtil.LOCATION_LOG_HUAQIANGBEI, MapNormalUtil.LOCATION_LAT_HUAQIANGBEI, "华强北地铁站", null, coType);
...
//                eNode = new BNRoutePlanNode(116.40386525193937, 39.915160800132085, "北京天安门", null, coType／);
    ...
    private void initSetting() {
        ...
        Bundle bundle = new Bundle();
        // 必须设置APPID，否则会静音
        bundle.putString(BNCommonSettingParam.TTS_APP_ID, "10056868");
