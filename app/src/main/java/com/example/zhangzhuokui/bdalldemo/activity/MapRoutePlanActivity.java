...
import com.example.zhangzhuokui.bdalldemo.adapter.RouteLineAdapter;
import com.example.zhangzhuokui.bdalldemo.util.BikingRouteOverlay;
import com.example.zhangzhuokui.bdalldemo.util.DrivingRouteOverlay;
import com.example.zhangzhuokui.bdalldemo.util.MassTransitRouteOverlay;
import com.example.zhangzhuokui.bdalldemo.util.OverlayManager;
import com.example.zhangzhuokui.bdalldemo.util.TransitRouteOverlay;
import com.example.zhangzhuokui.bdalldemo.util.WalkingRouteOverlay;
 ...
 * 同时展示如何进行节点浏览并弹出泡泡
 */
public class MapRoutePlanActivity extends Activity implements BaiduMap.OnMapClickListener,
...
//        PlanNode stNode = PlanNode.withCityNameAndPlaceName("北京", startNodeStr);//40.061490, 116.315050
//        PlanNode enNode = PlanNode.withCityNameAndPlaceName("北京", endNodeStr);//40.050776, 116.281525
        PlanNode stNode = PlanNode.withLocation(new LatLng(22.542838, 113.959495));//创维半导体设计大厦
        PlanNode enNode = PlanNode.withLocation(new LatLng(22.547244, 114.091833));//华强北地铁站
    ...
    public void nodeClick(View v) {
        ...
        // show popup
        popupText = new TextView(MapRoutePlanActivity.this);
    ...
    public void onGetWalkingRouteResult(WalkingRouteResult result) {
        ...
        if (result.error == SearchResult.ERRORNO.AMBIGUOUS_ROURE_ADDR) {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(MapRoutePlanActivity.this);
            builder.setTitle("提示");
        ...
        if (result.error == SearchResult.ERRORNO.NO_ERROR) {
            ...
            if (result.getRouteLines().size() > 1) {
                ...
                if (!hasShownDialogue) {
                    MyTransitDlg myTransitDlg = new MyTransitDlg(MapRoutePlanActivity.this,
