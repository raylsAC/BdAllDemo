...
public class HoverImageView extends ImageView {
	...
	private void setup(AttributeSet attrs) {
		if(attrs != null){
			...
			borderColor = typedArray.getColor(R.styleable.RoundImageView_roundBorderColor, borderColor);
			hoverColor = typedArray.getColor(R.styleable.RoundImageView_roundHoverColor, hoverColor);
			borderWidth = typedArray.getDimension(R.styleable.RoundImageView_roundBorderWidth, borderWidth);
			typedArray.recycle();
		}
